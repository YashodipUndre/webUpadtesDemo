                    ...
                    <div className="py-20 text-center border-2 border-dashed border-slate-100 rounded-[2rem] bg-slate-50/50">
                        ...
                        {(searchQuery || filterStatus !== "All") && (
                            <Button
                                ...
                                className="mt-4 px-6 py-2 bg-yellow-400 text-stone-900 font-black text-[11px] uppercase tracking-widest rounded-xl hover:bg-yellow-500 transition-colors shadow-lg shadow-yellow-200 h-auto"
                            >
                                Reset All Filters
                            </Button>
                        )}
                        ...
                        <Table className="min-w-[900px]">
                            <TableHeader>
                                <TableRow className="text-left text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] border-b border-slate-100 hover:bg-transparent">
                                    <TableHead className="px-6 py-5">Ref</TableHead>
                                    <TableHead className="px-6 py-5">Request & Items</TableHead>
                                    <TableHead className="px-6 py-5">Client Profile</TableHead>
